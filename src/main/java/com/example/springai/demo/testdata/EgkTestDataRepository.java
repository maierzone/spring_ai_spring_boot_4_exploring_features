...
/**
 * Persistiert einen {@link Dataset} via Batch-Inserts in die eGK-Tabellen und
 * liefert Auswertungen.
 *
 * <p>Nutzt {@link JdbcTemplate#batchUpdate} – fuer das gewuenschte grosse
 * Volumen (zehntausende Zeilen) deutlich performanter als Einzel-Inserts. Die
 * IDs werden vom Generator deterministisch vergeben und explizit eingefuegt
 * (die IDENTITY-Spalten sind {@code GENERATED BY DEFAULT}, erlauben das also),
 * sodass Fremdschluessel ohne Rueckfrage nach generierten Keys passen.</p>
 */
@Repository
