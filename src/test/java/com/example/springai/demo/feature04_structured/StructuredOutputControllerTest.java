...
class StructuredOutputControllerTest {
    ...
    void analysiertTicketInTypisiertesObjekt() {
        ...
        StructuredOutputController controller =
                new StructuredOutputController(ChatClient.builder(chatModel));

        TicketAnalysis result = controller.analyzeTicket("Nach dem Update kann ich mich nicht mehr einloggen!");
